...
function responsiveDesignMenuOverhaul() {
    ...
    var menuSelector = jQuery("#navigationMenu");
    jQuery(".hamburger-toggler").click(function() {
        jQuery(this).toggleClass("active");
        
        if(isMenuOpen){
            let menuWidth = "-" + menuSelector.outerWidth();
...
var latestHeader = [fullSizeHeaderBanner, responsiveDesignMenuOverhaul];
var latestContent = [fixTopMargin, removeMobileContentPadding];
